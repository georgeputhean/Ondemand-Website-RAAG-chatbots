  ...
  return (
    <div className="fixed top-4 right-4 z-50">
      <button
        ...
        className="flex items-center p-2 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-xl transition-all duration-200"
